...
<td>
  <div class="field" id="authorId" name="authorId"><a href="${baseUrl}/user/show/<c:out value='${bean.authorId.id}'/>"><c:out value="${bean.authorId.displayValue}" /></a></div>
</td>
</tr>
<tr>
...
<td>
  <div class="field" id="cuser" name="cuser"><a href="${baseUrl}/user/show/<c:out value='${bean.cuser.id}'/>"><c:out value="${bean.cuser.displayValue}" /></a></div>
</td>
</tr>
<tr>
...
<td>
  <div class="field" id="muser" name="muser"><a href="${baseUrl}/user/show/<c:out value='${bean.muser.id}'/>"><c:out value="${bean.muser.displayValue}" /></a></div>
</td>
</tr>
<tr>
...
<td>
  <div class="field" id="parentId" name="parentId"><a href="${baseUrl}/page/show/<c:out value='${bean.parentId.id}'/>"><c:out value="${bean.parentId.displayValue}" /></a></div>
</td>
</tr>
<tr>
