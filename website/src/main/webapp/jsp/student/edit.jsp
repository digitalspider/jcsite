	...
	<form action="<%=request.getContextPath()%>/student" method="post">
		<fieldset>
			...
			<div>
				...
				<input type="text" name="course" value="<c:out value="${student.course}" />" placeholder="Course" />
			</div>
			<div>
				<label for="year">Year</label>
				<input type="text" name="year" value="<c:out value="${student.year}" />" placeholder="Year" />
			</div>
			<div>
